package io.github.douglasliebl.mscustomers.api.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> handleMethodArgumenteNotValidException(MethodArgumentNotValidException e) {
